...
public class DataHandler {
    protected Map<String, String> id_map = new HashMap<String, String>();
    protected Map<BigInteger, String> originalid_map = new HashMap<BigInteger, String>();
    protected Map<String, ResourceTypeType> resourcemap = new HashMap<String, ResourceTypeType>();
    protected Map<String, NodeType> nodeRefMap = new HashMap<String, NodeType>();
    protected Map<String, TransitionResourceType> resourcepositionmap = new HashMap<String, TransitionResourceType>();
    protected Map<String, TriggerType> triggermap = new HashMap<String, TriggerType>();
    protected Map<String, TransitionType> dupjoinMap = new HashMap<String, TransitionType>();
    protected Map<String, TransitionType> dupsplitMap = new HashMap<String, TransitionType>();
    protected Map<BigInteger, Integer> xorremoveMap = new HashMap<BigInteger, Integer>();
    protected Map<BigInteger, TransitionType> xorrefMap = new HashMap<BigInteger, TransitionType>();
    protected Map<String, EdgeType> edgeRefMap = new HashMap<String, EdgeType>();
    protected Map<String, ArcType> duparcjoinMap = new HashMap<String, ArcType>();
    protected Map<String, ArcType> duparcsplitMap = new HashMap<String, ArcType>();
    protected Map<String, Object> pnmlRefMap = new HashMap<String, Object>();
    protected Map<BigInteger, Object> duppnmlRefMap = new HashMap<BigInteger, Object>();
    protected Map<String, String> anno_string = new HashMap<String, String>();
    protected Map<String, Integer> operatortype = new HashMap<String, Integer>();
    protected Map<String, NodeType> specialoperators = new HashMap<String, NodeType>();
    protected Map<String, Integer> specialoperatorscount = new HashMap<String, Integer>();
    protected Map<String, ANDSplitType> andsplits = new HashMap<String, ANDSplitType>();
    protected Map<String, ANDJoinType> andjoins = new HashMap<String, ANDJoinType>();
    protected Map<String, XORSplitType> xorsplits = new HashMap<String, XORSplitType>();
    protected Map<String, XORJoinType> xorjoins = new HashMap<String, XORJoinType>();

    protected List<String> targetvalues = new LinkedList<String>();
    protected List<String> sourcevalues = new LinkedList<String>();
    protected List<String> output = new LinkedList<String>();
    protected List<String> input = new LinkedList<String>();
    protected List<TransitionType> subnets = new LinkedList<TransitionType>();
    protected List<String> units = new LinkedList<String>();
    protected List<String> roles = new LinkedList<String>();
    protected List<NodeType> xorconnectors = new LinkedList<NodeType>();
    protected org.apromore.pnml.NetType subnet = new org.apromore.pnml.NetType();
    protected String inputnode = "start";
    protected String outputnode = "end";
    protected PnmlType pnml = new PnmlType();
    protected org.apromore.pnml.NetType net = new org.apromore.pnml.NetType();
    protected long ids = System.currentTimeMillis();
    protected String filename;
    protected AnnotationsType anno = new AnnotationsType();
    protected List<org.apromore.pnml.NodeType> xors = new LinkedList<org.apromore.pnml.NodeType>();
    protected List<ArcType> xorarcs = new LinkedList<ArcType>();
